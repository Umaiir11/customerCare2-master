...
class VwPendingSaleOrder extends StatefulWidget {
  ...
  @override
  State<VwPendingSaleOrder> createState() => _VwPendingSaleOrderState();
}

class _VwPendingSaleOrderState extends State<VwPendingSaleOrder> {
  final l_SearchController = Get.put(SrPendingSaleOrder());
  ...
  void initState() {
    ...
    l_SearchController.Pr_filteredList.value.addAll(l_SearchController.l_PrPendingSaleOrderList!);
                                            ...
                                            children: [
                                              ...
                                              RichText(
                                                text: TextSpan(
                                                  ...
                                                  children: [
                                                    l_SearchController.getMatchedTextSpan(
                                                      l_SearchController.Pr_filteredList[index].Pr_CustomerRefNo,
                                                      l_SearchController.searchText.value,
                                                    ),
                                                  ],
                                                ),
                                                  ...
                                                  children: [
                                                    l_SearchController.getMatchedTextSpan(
                                                        G_currencyFormat.format(
                                                            l_SearchController.Pr_filteredList[index].Pr_FGrandTotal),
                                                        l_SearchController.searchText.value),
                                                  ],
                                                ),
                                              ),
